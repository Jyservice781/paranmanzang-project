...
export const groupApi = {
    ...
    modifyChatRoomId(groupModel: GroupResponseModel, groupId: number) {
        return api.put<GroupResponseModel | ExceptionResponseModel>(requests.fetchGroups + `/groups/chat-room/${groupId}`, { groupModel });
    },
