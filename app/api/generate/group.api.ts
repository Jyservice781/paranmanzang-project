...
export const groupApi = {
    ...
    modifyChatRoomId(model: GroupResponseModel, groupId: number) {
        return api.put<GroupResponseModel | ExceptionResponseModel>(requests.fetchGroups + `/groups/chat-room/${groupId}`, { model });
    },
