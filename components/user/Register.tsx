"use client"
import { RegisterModel } from "@/models/user/user.model"
  ...
  return (
    <div className="my-6 py-40">
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-5 flex items-center space-x-4 rounded-lg border bg-gray-50 p-4 transition hover:bg-gray-100">
          <input
            type="checkbox"
            id="isSeller"
            checked={isSeller}
            onChange={handleSellerChange}
            className="size-5 rounded border-gray-300 text-green-500 focus:ring-green-400"
          />
